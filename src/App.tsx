      ...
      <PastelUi.ResponsiveContainer $maxWidth='1280px' $margin='auto'>
        ...
        <PastelUi.Flex>
          ...
          <PastelUi.Flex $direction='column' $flex='3'>
            <PastelUi.Card $title='Product' $description='Description of the product' $price={"$20.00"} $button1Text='Coucou' $image='https://images.unsplash.com/photo-1555041469-a586c61ea9bc?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1770&q=80'/>
          </PastelUi.Flex>
        </PastelUi.Flex>
